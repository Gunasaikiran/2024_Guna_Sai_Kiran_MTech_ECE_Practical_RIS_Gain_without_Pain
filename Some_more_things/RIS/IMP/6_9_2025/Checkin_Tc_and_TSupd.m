...
grid on;
% Save the figure
saveas(gcf, 'PF_Rate_vs_Tau_32N_25K_more.fig');   % Save as .fig (MATLAB format)
saveas(gcf, 'PF_Rate_vs_Tau_32N_25K_more.png');   % Save as .png (image format)
