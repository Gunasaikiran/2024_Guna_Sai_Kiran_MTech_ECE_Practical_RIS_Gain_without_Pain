...
%% Parameters
N = 16; % IRS elements
K = 16; % Fixed number of users
txt_SNR_dB = 107.83;
txt_SNR_lin = 10^(txt_SNR_dB/10);
tot_time_slots = 500000;
Number_of_setups = 10;

Ts_values = [1,2,4,8,16,32,64,100,1000];
tau_values = [2, 10, 25, 50, 100, 250, 500, 1000, 5000, 10000, 20000, 30000, 50000];
...
grid on;
% Save the figure
saveas(gcf, 'PF_Rate_vs_Tau_16N_100K_more.fig');   % Save as .fig (MATLAB format)
saveas(gcf, 'PF_Rate_vs_Tau_16N_100K_more.png');   % Save as .png (image format)
