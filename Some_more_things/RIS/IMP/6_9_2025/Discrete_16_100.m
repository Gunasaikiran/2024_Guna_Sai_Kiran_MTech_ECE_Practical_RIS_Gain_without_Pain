...
grid on;
% Save the figure
saveas(gcf, 'PF_Rate_vs_Tau_16N_100K.fig');   % Save as .fig (MATLAB format)
saveas(gcf, 'PF_Rate_vs_Tau_16N_100K.png');   % Save as .png (image format)
